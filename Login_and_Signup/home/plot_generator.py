...
def plot_recruiter(company_dict):
    ...
    plt.savefig('static/img/plots/top_recruiter_plot.png') # Save figure 
...
def plot_education(education_dict):
    ...
    plt.tight_layout()
    plt.savefig('static/img/plots/education_plot.png')
...
def plot_job_type(job_type_dict):
    ...
    plt.savefig('static/img/plots/job_type_plot.png')
...
def plot_job_language(job_language_dict):
    ...
    plt.tight_layout() 
    plt.savefig('static/img/plots/job_language_plot.png')
...
def plot_locations(job_location_dict):
    ...
    india_map.save("static/html/job_openings_map.html")